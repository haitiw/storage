...
extern pthread_mutex_t mutex_client_request, mutex_sqlite, mutex_refresh,
    mutex_sms, mutex_buzzer, mutex_transfer, mutex_led;

extern pthread_cond_t cond_client_request, cond_sqlite, cond_refresh, cond_sms,
    cond_buzzer, cond_transfer, cond_led;

extern pthread_t tid_client_request, tid_sqlite, tid_refresh, tid_sms,
    tid_buzzer, tid_transfer, tid_led;
